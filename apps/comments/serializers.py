...
class CommentMediaSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        read_only_fields = ["id", "file", "media_file", "created_at"]
...
class CommentReadSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'post', 'parent','commenter', 'comment_text', 'created_at', 'updated_at', 'likes_count', 'is_liked','media','replies']
...
class CommentWriteSerializer(serializers.ModelSerializer):
    ...
    def Validate_uploaded_files(self , file):
        ...
        #     raise serializers.ValidationError("You can upload at most 3 files.")
